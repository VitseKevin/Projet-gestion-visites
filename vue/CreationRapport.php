...
<body>
    ...
    <form action="../controller/passerelleRapport.php" method="post">
        ...
        <br>
        <input type='text' name='quantite' placeholder='Quantité' required></input>
        <br>
        <input type="submit" value="Créer" ></input>
        <input type='button' onclick="window.location.href='gestion rapport.php';" value='Retour'></input>
    </form>
